...
def data_initialization(data):
    ...
    data.build_lm_alphabet(data.s_lm)
    data.build_lm_alphabet(data.t_lm)
    if data.mode == 'finetune':
        data.build_alphabet(data.s_ner_train, target=False, build_label_alphabet=True)
        data.build_alphabet(data.s_ner_eval, target=False, build_label_alphabet=True)
    else:
        data.build_alphabet(data.s_ner_train, target=False, build_label_alphabet=False)
        data.build_alphabet(data.s_ner_eval, target=False, build_label_alphabet=False)
...
def train(data):
    ...
    if data.mode == 'finetune':
        ...
        for idx in range(data.HP_iteration):
            ...
            speed, acc, p, r, f, _, _ = evaluate(data, s_model, "s_dev")
